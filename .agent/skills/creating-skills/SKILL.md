...
description: Generates or creates a new skill directory and its SKILL.md for the Antigravity agent environment based on user requirements. Use this skill whenever the user explicitly asks to create a global or local skill.
---
